...
--Показываются все сотрудники с зарплатой > 55000, а dept_name подставляется
-- из departments. Если у кого-то нет отдела,
-- он всё равно появится, но с dept_name = NULL
--да, видны все, в том числе с NULL в dept_id. c INNER JOIN, сотрудники
-- без отдела исчезли бы из результата, даже если их зарплата > 55000.
